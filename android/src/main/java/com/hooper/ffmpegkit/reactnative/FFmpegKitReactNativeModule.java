...
package com.hooper.ffmpegkit.reactnative;
...
import com.hooper.ffmpegkit.AbiDetect;
import com.hooper.ffmpegkit.AbstractSession;
import com.hooper.ffmpegkit.FFmpegKit;
import com.hooper.ffmpegkit.FFmpegKitConfig;
import com.hooper.ffmpegkit.FFmpegSession;
import com.hooper.ffmpegkit.FFprobeKit;
import com.hooper.ffmpegkit.FFprobeSession;
import com.hooper.ffmpegkit.Level;
import com.hooper.ffmpegkit.LogRedirectionStrategy;
import com.hooper.ffmpegkit.MediaInformation;
import com.hooper.ffmpegkit.MediaInformationJsonParser;
import com.hooper.ffmpegkit.MediaInformationSession;
import com.hooper.ffmpegkit.Packages;
import com.hooper.ffmpegkit.ReturnCode;
import com.hooper.ffmpegkit.Session;
import com.hooper.ffmpegkit.SessionState;
import com.hooper.ffmpegkit.Signal;
import com.hooper.ffmpegkit.Statistics;
...
public class FFmpegKitReactNativeModule extends ReactContextBaseJavaModule {
  ...
  public void abstractSessionGetAllLogs(final Double sessionId, final Double waitTimeout, final Promise promise) {
    if (sessionId != null) {
      ...
      if (session == null) {
        ...
        final List<com.hooper.ffmpegkit.Log> allLogs = session.getAllLogs(timeout);
  ...
  public void abstractSessionGetLogs(final Double sessionId, final Promise promise) {
    if (sessionId != null) {
      ...
      if (session == null) {
        ...
        final List<com.hooper.ffmpegkit.Log> allLogs = session.getLogs();
        promise.resolve(toLogArray(allLogs));
      }
    } else {
      promise.reject("INVALID_SESSION", "Invalid session id.");
  ...
  protected static WritableMap toMap(final com.hooper.ffmpegkit.Log log) {
  ...
  protected static WritableArray toLogArray(final List<com.hooper.ffmpegkit.Log> logList) {
  ...
  protected static WritableArray toStatisticsArray(final List<com.hooper.ffmpegkit.Statistics> statisticsList) {
