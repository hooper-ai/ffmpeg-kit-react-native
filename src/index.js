...
class FFmpegKitInitializer {
  ...
  static async initialize() {
    ...
    console.log("Loading @hooper-ai/ffmpeg-kit-react-native.");
    ...
    console.log(`Loaded @hooper-ai/ffmpeg-kit-react-native-${platform}-${packageName}-${arch}-${version}${isLTSPostfix}.`);
  }
